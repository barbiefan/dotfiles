...
while [ "$#" -gt 0 ]; do
  case $1 in
    ...
    -s|--lowdpi)    WIDTH=$(($WIDTH / 2)); HEIGHT=$(($HEIGHT / 2))
                    MODE_NAME="$MODE_NAME""_lowdpi" ;;
...
function finish {
  ...
  /home/obey/.bins/notification "Screen" "Second screen is disabled"
}
...
echo $CLIP_POS
# Share screen
/home/obey/.bins/notification "Screen" "Second screen is enabled"
